<section class="login-form">
	...
	<form method="post" action="/user/login" role="login">
		...
		<div class="form-group text-center">
           <p><?php echo $this->lang->line('Views_User_Login_NotRegistred');?> ?  <br><a href="<?php echo base_url('user/register'); ?>"><?php echo $this->lang->line('Views_User_Login_Registrer');?></a> </p>
